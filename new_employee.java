...
import java.io.*;
import javax.swing.*;
public class new_employee implements ActionListener {
    JFrame f;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee_details values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"')";
